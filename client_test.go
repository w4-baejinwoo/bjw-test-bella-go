...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Qna.API.V1.Documents.BulkNew(context.Background(), bjwtestbella.QnaAPIV1DocumentBulkNewParams{
	...
	if userAgent != fmt.Sprintf("BjwTestBella/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Qna.API.V1.Documents.BulkNew(context.Background(), bjwtestbella.QnaAPIV1DocumentBulkNewParams{
		Documents: []bjwtestbella.QnaAPIV1DocumentBulkNewParamsDocument{{
			ID:   "id",
			Type: "plain",
		}},
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Qna.API.V1.Documents.BulkNew(cancelCtx, bjwtestbella.QnaAPIV1DocumentBulkNewParams{
		Documents: []bjwtestbella.QnaAPIV1DocumentBulkNewParamsDocument{{
			ID:   "id",
			Type: "plain",
		}},
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Qna.API.V1.Documents.BulkNew(deadlineCtx, bjwtestbella.QnaAPIV1DocumentBulkNewParams{
			Documents: []bjwtestbella.QnaAPIV1DocumentBulkNewParamsDocument{{
				ID:   "id",
				Type: "plain",
			}},
