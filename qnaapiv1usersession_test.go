...
func TestQnaAPIV1UserSessionClearContext(t *testing.T) {
	...
	_, err := client.Qna.API.V1.Users.Sessions.ClearContext(
		context.TODO(),
		"sessionId",
		bjwtestbella.QnaAPIV1UserSessionClearContextParams{
			UserID:  "userId",
			XAPIKey: "x-api-key",
			XUserID: "x-user-id",
		},
